...
public class CountryCitizensKick extends Command {
    @Override
    public String[] names() {
    ...
    public String permission() {
        return "wf.country.citizen.kick";
    }
    ...
    public CommandExecutor executor() {
        return (src, args) -> {
            ...
            if (country == null)
                ...
                if (country.isLeader(player.getName()))
                    src.sendMessage(Text.of("He's leader!"));
                else
                    country.removeCitizen(player.getName());
            else
