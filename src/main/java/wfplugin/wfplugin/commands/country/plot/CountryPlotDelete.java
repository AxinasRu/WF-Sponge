...
public class CountryPlotDelete extends Command {
    @Override
    public String[] names() {
    ...
    public CommandExecutor executor() {
        return (src, args) -> {
            ...
            if (plot == null)
                ...
                country.plots.remove(plot);
                src.sendMessage(WFPlugin.strings.plotDelete(plot.name));
            }
